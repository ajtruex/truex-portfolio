  ...
  return (
    ...
    // <div className="overflow-hidden mx-auto max-w-5xl flex-col align-center justify-center py-8 px-5 xl:px-0">
      <div className="flex flex-col items-start md:px-5">
        ...
        <div className="fixed z-10 cursor-pointer flex-row items-center  rounded-full border bg-white bg-opacity-95 px-6 py-2 shadow-xl backdrop-blur-sm backdrop-filter dark:border-slate-100/10 dark:bg-black dark:bg-opacity-75 lg:left-1/2 lg:flex lg:-translate-x-1/2 lg:transform ml-12 top-8">
          <div>
            <div
